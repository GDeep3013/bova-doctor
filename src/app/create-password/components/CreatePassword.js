                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 py-5 w-full max-w-screen-sm">
                            ...
                            <div className="flex items-center justify-between">
                                <label className="flex items-center space-x-2 cursor-pointer">
                                    <input type="checkbox" className="form-checkbox w-5 h-5" checked={isChecked}
                                        onChange={handleCheckboxChange} />
                                    <span className='text-textColor text-base'><Link href='/terms-services' className="underline" target='_blank'>Accept Terms of Service </Link></span>
                                </label>
                            </div>
                            <button type="submit"
                                className={`w-full py-2 bg-black text-white font-bold rounded hover:bg-customText focus:outline-none min-h-[50px]
                                ${!isChecked || loader? "cursor-not-allowed opacity-50" : ""}`}
