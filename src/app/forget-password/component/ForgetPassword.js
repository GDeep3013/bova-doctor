...
export default function ForgetPassword() {
      ...
      try {
        ...
        if (response.ok) {
          Swal.fire({
            ...
            text: 'Check your email! We’ve sent a link to reset your password. Be sure to check your spam folder if you don’t see it in your inbox. ',        
  ...
  return (
    <div className='login-outer'>
      ...
      <div className="min-h-screen h-full p-[20px] pb-[40px] bg-[url('/images/small-device.jpg')] md:p-0 min-[768px]:bg-[url('/images/login-mobile.jpg')] min-[1025px]:bg-[url('/images/login-bg.jpg')] min-[2000px]:bg-[url('/images/login-img-new.webp')] bg-no-repeat bg-cover relative login-after login-outer">
          <div className="w-full md:max-w-[400px] lg:max-w-[480px] min-[1700px]:max-w-[600px] max-w-[100%] bg-[rgba(255,255,255,80%)] 2xl:p-8 p-5 flex flex-col items-center justify-center absolute lg:right-16 xl:right-37 min-[1700px]:right-40 z-[1] md:top-[50%] md:translate-y-[-50%] md:translate-x-[0] rounded-[20px] login-form">
            ...
            <Link href="/"> <img src='/images/logo.png' alt='logo' className='md:max-w-[144px] xl:max-w-[166px] max-w-[150px] m-auto mb-2'/> </Link>
