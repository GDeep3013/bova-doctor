...
export default function PrivacyPolicy() {
    return (
        <div className="min-h-screen ms-10 mt-10">
            <div className="max-w-4xl rounded-lg">
                ...
                <h2 className="text-xl font-semibold text-[#53595B]  mb-4">1. Information We Collect</h2>
                ...
                <h2 className="text-xl font-semibold text-[#53595B]  mb-4">2. How We Use Your Information</h2>
                <ul className="list-disc list-inside text-gray-700 mb-6">
                ...
                <h2 className="text-xl font-semibold text-[#53595B] mb-4">3. Data Security</h2>
                ...
                <h2 className="text-xl font-semibold text-[#53595B] mb-4">4. Sharing Your Information</h2>
                <p className="text-gray-700 mb-6">
                ...
                <h2 className="text-xl font-semibold text-[#53595B] mb-4">6. Changes to This Policy</h2>
                <p className="text-gray-700 mb-6">
