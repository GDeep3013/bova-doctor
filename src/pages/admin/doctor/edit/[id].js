...
export default function CreateDoctor() {
    const { specialty, setSpecialty, phone, setPhone, firstName, setFirstName, lastName, setLastName, email, setEmail, errors, setErrors, userType, setUserType } = useAppContext();
        ...
        if (validateForm()) {
            try {             
                ...
                const response = await fetch(`/api/doctors/edit/${id}`, {
                    ...
                    body: JSON.stringify({ id, firstName, lastName, email, phone, specialty, userType }),
                });
                if (response.ok) {
                    Swal.fire({
                        title: 'Success!',
